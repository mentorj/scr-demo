...
public class MainGUI extends JFrame {
	...
	public MainGUI(){
		...
		actions=new ArrayList<IAction>(5);
...
//			model.addElement(action);
	...
	private void bootstrap() {
		...
		Border buttonPanelBorder =
			      BorderFactory.createTitledBorder("Invoking action");
		...
		jbLaunchAction.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				Object obj =jlActions.getModel().getElementAt(selected_action_index);
		...
		Border plugins_border =
			      BorderFactory.createTitledBorder("Available plugins");
